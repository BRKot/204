...
int** Make_TSPMatrix()	
{
	...
	cout << "Матрица с расстояниями между магазинами: \n";
	Print_Matrix(matrix);
	return matrix;
}
...
void Print_Result()
{
	...
	cout << "\nКратчайшее растояние между магазинами = " << sum << "км"<<endl;;
}
...
void makeGraph()	
{
	...
	cout << "Введите количество магазинов: "; cin >> amountVerts;
	cout << "Введите количество дорог между магазинами: "; cin >> amountEdges;
	...
	{
		cout << "Начальный магазин: "; cin >> sourceVertex;
		cout << "Конечный магазин: "; cin >> targetVertex;
		cout << "Расстояние между магазинами: "; cin >> edgeWeight;
